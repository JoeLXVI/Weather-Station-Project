...
class PressureSensor:
    ...
    def ReadData(self):
        ...
        time.sleep(0.01)
        data = self.I2C.readfrom_mem(self.address, self.RegistersDictionary["PressureData"], 4) #Reading 4 Bytes of data
    ...
    def PowerDown(self):
       ReadRegister = self.I2C.readfrom_mem(self.address,self.RegistersDictionary["Command"], 1)[0]
       ReadRegister &=0xFE #Set bit 0 to 0 (standby mode)
       self.I2C.writeto_mem(self.address,self.RegistersDictionary["Command"], bytearray([ReadRegister]))
    ...
    def StatusCheck(self):
        ...
        try:
            data = self.I2C.readfrom_mem(self.address,self.RegistersDictionary["Command"], 1)[0]
