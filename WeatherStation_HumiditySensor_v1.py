...
class HumiditySensor:
    ...
    def ReadData(self):
        raw_data = self.I2C.read_from_mem(self.address, self.RegistersDictionary["HumidityData"],2)
    ...
    def StatusCheck(self):
        ...
        try:
            data = self.I2C.readfrom_mem(self.address, self.RegistersDictionary["Status"], 1 )[0]
